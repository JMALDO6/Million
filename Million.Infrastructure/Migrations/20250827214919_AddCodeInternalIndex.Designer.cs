...
namespace Million.Infrastructure.Migrations
{
    ...
    [Migration("20250827214919_AddCodeInternalIndex")]
    partial class AddCodeInternalIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Million.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Million.Domain.Entities.Owner", b =>
                {
            ...
            modelBuilder.Entity("Million.Domain.Entities.Property", b =>
                {
            ...
            modelBuilder.Entity("Million.Domain.Entities.PropertyImage", b =>
                {
            ...
            modelBuilder.Entity("Million.Domain.Entities.PropertyTrace", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Million.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Million.Domain.Entities.Property", b =>
                {
                    b.HasOne("Million.Domain.Entities.Owner", "Owner")
                        .WithMany("Properties")
            ...
            modelBuilder.Entity("Million.Domain.Entities.PropertyImage", b =>
                {
                    b.HasOne("Million.Domain.Entities.Property", "Property")
